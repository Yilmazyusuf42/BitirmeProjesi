...
public class EnemyFireWizardAttackState : EnemyState
{
    private EnemyFireWizard enemy;
    private float attackTimer;
    private float attackDuration = 1.1f;

    public EnemyFireWizardAttackState(EnemyStateMachine stateMachine, EnemyBase enemyBase, string animBoolName, EnemyFireWizard enemy)
