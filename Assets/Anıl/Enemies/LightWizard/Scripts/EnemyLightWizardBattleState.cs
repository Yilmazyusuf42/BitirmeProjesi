...
public class EnemyLightWizardBattleState : EnemyState
{
    private EnemyLightWizard enemy;

    public EnemyLightWizardBattleState(EnemyStateMachine stateMachine, EnemyBase enemyBase, string animBoolName, EnemyLightWizard enemy)
