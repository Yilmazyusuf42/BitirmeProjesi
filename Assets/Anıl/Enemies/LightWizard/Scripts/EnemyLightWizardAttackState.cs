...
public class EnemyLightWizardAttackState : EnemyState
{
    private EnemyLightWizard enemy;
    private float attackTimer;
    private float attackDuration = 1.1f;

    public EnemyLightWizardAttackState(EnemyStateMachine stateMachine, EnemyBase enemyBase, string animBoolName, EnemyLightWizard enemy)
